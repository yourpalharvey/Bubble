...
export const FullBubble = (props) => {
  return (
    <div
      className={styles.fullBubbleContainer}
      style={{ backgroundColor: props.colour }}
    >
      <div className={styles.fullText}>
        <h3 className={styles.fullHeading}>{props.text}</h3>
        <div className={styles.fullPText}>
          <p className={styles.fullVenue}>{props.venue}</p>
        </div>
        <div className={styles.fullDate}>
          <p className={styles.fullEventDate}>{props.date}</p>
        </div>
...
export const MiniWideBubble = (props) => {
  return (
    <Link href={`/${props.url}`}>
      <div
        className={styles.miniWideContainer}
        style={{ backgroundColor: props.colour }}
      >
        ...
        <div className={styles.miniWideText}>
          <h3 className={styles.miniWideHeading}>{props.eventName}</h3>
          <div className={styles.miniWideUser}>
            <p className={styles.miniWideUserName}>{props.userName}</p>
          </div>
        </div>
