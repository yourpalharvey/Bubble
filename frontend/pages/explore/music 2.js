...
export default function Explore({ loggedIn, user, data}) {
  ...
  if (showCategories == true) {
    contentRendered = <ExploreCategoriesFilter music={true} data={data}/>;
  } else if (showBubbles == true) {
    contentRendered = <ExploreBubblesFilter music={true}/>;
  } else {
    contentRendered = <ExploreStreamsFilter music={true} />;
  }
